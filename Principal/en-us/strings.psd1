...
@{
	...
	'Resolve-Principal.Resolve.Domain.Error'    = 'Unable to resolve domain of principal {0}' # $Name
	'Resolve-Principal.Resolve.Principal.Error' = 'Unable to resolve principal {0}' # $Name
